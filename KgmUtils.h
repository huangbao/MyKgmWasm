...
#ifndef MYKGMWASM_KGMUTILS_H
#define MYKGMWASM_KGMUTILS_H
...
static std::vector<uint8_t> table2 = {
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
...
static std::vector<uint8_t> MaskV2PreDef = {
...
static uint8_t *readFile(char *filepath, int *bufferSize) {
    ...
    file.read(reinterpret_cast<char *>(buffer), fileSize); // 读取数据到buffer中
